/**
 * iHelp NPS Widget - Script de Instalação Completo
 * 
 * Este script contém tudo o que é necessário para adicionar o widget NPS em qualquer site.
 * Basta incluir este script e chamar a função initNPSWidget com suas configurações.
 * 
 * Exemplo de uso:
 * <script src="install-nps-widget.js"></script>
 * <script>
 *   initNPSWidget({
...
(function(window) {
  ...
  // ========== INÍCIO DO CÓDIGO DO WIDGET NPS ==========
  // Main widget class
  class NPSWidget {
  ...
  // ========== FIM DO CÓDIGO DO WIDGET NPS ==========

  // ========== INÍCIO DO CÓDIGO DE INSTALAÇÃO ==========
  // Configuração padrão
  const defaultConfig = {
    userId: 'anonymous',
